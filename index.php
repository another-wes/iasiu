        ...
        <nav id="tf-menu" class="navbar navbar-default navbar-fixed-top">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html">Alabama IASIU</a>
                </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <p class="intro justify">
                                    The Alabama Chapter of the IASIU is represents more than 60 insurance and self-insured companies around the state. The AL-IASIU is open to anyone that works in the insurance or self-insured special investigation units, special agents or supervisors of the National Insurance Crime Bureau or Insurance Crime Prevention Bureau as well as insurance company personnel who support the investigative process and the law enforcement community involved in insurance fraud investigation through the state of Alabama.
                ...
                <div id="tf-clients" class="text-center">
                    <div class="overlay">
                        <div class="container">
                            ...
                            <div id="clients">
                                <div class="row">
                                    <a href="https://www.nicb.org/speak_up/speak-up">
                        ...
                        <div class="row">
                            <table class="table-striped table-hover">
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="http://iasiu-singlepage.herokuapp.com/img/fast-lab-logo3.png" alt="" />
                                        </td>
                                        <!-- <span class="fa fa-dot-circle-o"></span> -->
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <img src="http://iasiu-singlepage.herokuapp.com/img/leading_edge.png" alt="" />
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img src="http://iasiu-singlepage.herokuapp.com/img/cna_logo.gif" alt="" />
                                        </td>
                                        <td>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <div class="section-title center">
                                ...
                                <div class="clearfix"></div>
                                <small><em>Thank you for contacting us, we are here to help you in the fight against insurance fraud.</em></small>
                            </div>
